(function () {
  ...
  function boot () {
    ...
    let bundledScript = settings.debug ? 'src/project.dev.js' : 'src/project.b1fec.js';
      if (jsList) {
  ...
  if (window.document) {
    ...
    cocos2d.async = true;
    cocos2d.src = window._CCSettings.debug ? 'cocos2d-js.js' : 'cocos2d-js-min.eb0e2.js';
