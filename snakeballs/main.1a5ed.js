(function () {
  ...
  function boot () {
    ...
    let bundledScript = settings.debug ? 'src/project.dev.js' : 'src/project.56d3d.js';
      if (jsList) {
  ...
  if (window.document) {
    ...
    cocos2d.async = true;
    cocos2d.src = window._CCSettings.debug ? 'cocos2d-js.js' : 'cocos2d-js-min.41ea4.js';
