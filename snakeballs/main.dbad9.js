(function () {
  ...
  function boot () {
    ...
    function getLaunchScene() {
      ...
      if(winWidth / winHeight < mapWidth / mapHeight){
        return 'game';
      }else{
        return 'game2';
      }
    ...
    let bundledScript = settings.debug ? 'src/project.dev.js' : 'src/project.51b87.js';
      if (jsList) {
  ...
  if (window.document) {
    ...
    cocos2d.async = true;
    cocos2d.src = window._CCSettings.debug ? 'cocos2d-js.js' : 'cocos2d-js-min.e8da7.js';
